...
public interface IElasticRepository
{
    ...
    Task<BookResponse[]> Search(double? minimumRating, double? maximumRating, CancellationToken cancellationToken = default);
    ...
    Task<BookResponse[]> SearchInFields(string[] fieldsList, string query, CancellationToken cancellationToken = default);
